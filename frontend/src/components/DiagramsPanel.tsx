...
// that corrupts with concurrent calls (all three panels mounting at once).
...
// ---------------------------------------------------------------------------
// DiagramView — full-panel single diagram
// ---------------------------------------------------------------------------

type DiagramTab = "current" | "auto" | "steered";

const TAB_CONFIG: Record<DiagramTab, { label: string; sublabel: string; accent: string; activeClass: string }> = {
...
function DiagramView({ source, tab, hasContent, emptyMessage }: DiagramViewProps) {
