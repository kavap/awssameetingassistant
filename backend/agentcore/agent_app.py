...
_HAIKU = os.environ.get("BEDROCK_HAIKU_MODEL", "anthropic.claude-haiku-4-5-20251001-v1:0")
_SONNET = os.environ.get("BEDROCK_SONNET_MODEL", "anthropic.claude-sonnet-4-6-20250514-v1:0")
