...
_HAIKU = os.environ.get("BEDROCK_HAIKU_MODEL", "anthropic.claude-3-5-haiku-20241022-v1:0")
_SONNET = os.environ.get("BEDROCK_SONNET_MODEL", "anthropic.claude-3-7-sonnet-20250219-v1:0")
